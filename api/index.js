...
export const getSample = async (sampleId, token, atlasApiUrl) => {
...
export const getExperiment = (experimentId, token, atlasApiUrl) => {
  return axios.get(`${atlasApiUrl}/${labGroup}/xp/${experimentId}/`,
    { headers: { Authorization: token } }
  );
}

export const getAnalysis = async (analysisId, token, atlasApiUrl) => {
...
export const getExperimentbyExternalId = (externalId, experimentType, token, atlasApiUrl) => {
  return axios.get(`${atlasApiUrl}/${labGroup}/xp/${experimentType}?by_keywords=${externalId}&search_on=s_external_identifier`,
    { headers: { Authorization: token } }
  );
}

export const addSample = (sample, sampleType, token, atlasApiUrl) => {
...
export const addExperiment = (experiment, experimentType, token, atlasApiUrl) => {
...
export const addAnalysis = (analysis, analysisType, token, atlasApiUrl) => {
...
export const deleteSample = (sampleId, sampleType, token, atlasApiUrl) => {
  return axios.delete(`${atlasApiUrl}/${labGroup}/samples/${sampleType}/${sampleId}`,
    { headers: { Authorization: token } }
  );
}

export const deleteExperiment = (experimentId, experimentType, token, atlasApiUrl) => {
  return axios.delete(`${atlasApiUrl}/${labGroup}/xp/${experimentType}/${experimentId}`,
    { headers: { Authorization: token } }
  );
}

export const deleteAnalysis = (analysisId, analysisType, token, atlasApiUrl) => {
